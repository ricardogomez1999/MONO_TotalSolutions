...
export default function ContactUs() {
  ...
  return (
    <div className=" md:w-3/4 mx-auto gap-10 justify-center items-center">
      <div className="w-full md:hidden flex flex-col items-center justify-around md:rounded-s-xl">
        ...
        >
          ...
          <InboxArrowDownIcon className=" w-8 text-darkBlue " />
        </a>
      </div>
      <div className=" flex md:h-[500px]">
        <div className="w-1/2  hidden md:flex flex-col items-center justify-around bg-lightBlue md:rounded-s-xl">
          <h1 className=" text-2xl font-bold text-center">
          ...
          >
            ...
            <InboxArrowDownIcon className=" w-8 text-white " />
          </a>
        </div>
